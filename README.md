...
## 🚀 Concept
Termux AGI is a mobile AI research lab that runs completely on your device. It utilizes the **Qwen3.5-0.8B** LLM and **ChromaDB** to create a self-improving, autonomous knowledge network.
...
3. **Clone the Repository:**
   ```bash
   git clone https://github.com/abdulraheemnohri/Termux-AGI-Control-Center.git
   cd termux-agi
   ```
...
## ⚠️ Notes
- The first time you run a chat command or start research, the system will download the **Qwen3.5-0.8B** model and embedding models.
